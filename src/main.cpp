...
void setMaterialUniforms(GLuint shaderProgram, const Material& material) {
    ...
    glUniform1i(glGetUniformLocation(shaderProgram, "hasDiffuseTexture"), material.hasTexture);
    
    if (material.hasTexture && material.diffuseTexture.id != 0) {
